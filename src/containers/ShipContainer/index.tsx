...
const ShipContainer = () => {
    return (
        ...
        <div className="flex flex-col min-h-screen">
            <div className="flex flex-wrap justify-center min-h-[500px] ferry-app relative z-50 pb-24">
                <div className="absolute inset-0 bg-gradient-to-b from-transparent to-white/20 z-0"></div>
                <div className="flex flex-wrap justify-center items-center w-full py-12 px-6 lg:px-20 relative z-10 max-w-[1440px]">
            ...
            <div className="flex flex-wrap justify-center relative z-10 px-4 -mt-12 mb-12">
