            ...
            <div className="mt-6 p-4 rounded-xl bg-gradient-to-r from-orange-500/20 to-primary/20 border border-orange-500/30 flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-slate-600 text-xs md:text-sm mt-1">Klik widget chat di pojok kanan bawah dan ketik <span className="font-mono bg-orange-500/10 text-orange-700 px-1.5 py-0.5 rounded border border-orange-500/20">&quot;Tiket kapal Batam ke Singapura besok&quot;</span></p>
                    </div>
                </div>
            </div>
        </div>
